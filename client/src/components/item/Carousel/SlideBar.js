    ...
    <div className={classes.post_feature}>
      ...
      <div className={classes.post_feature_info}>
        ...
        <p className={classes.post_desc}>
          ...
          (self_help) bán chạy nhất từ trước đến nay. Quyển sách này do Dale
          Carnegie viết và đã được xuất bản lần đầu vào năm 1936, nó đã được bán
          15 triệu bản trên khắp thế giới.
        </p>
